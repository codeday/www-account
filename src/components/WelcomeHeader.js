      ...
      <Text>
        ...
        <Text bold as="span">
          ...
          <Box
            ...
            paddingRight={1}
            d={
              user.roles.find((role) => role.name === 'Employee' || role.name === 'Staff' || role.name === 'Volunteer')
                ? 'inline-block'
                : 'none'
            }
            fontSize="xs"
            fontWeight="bold"
            backgroundColor={
              (user.roles.find((role) => role.name === 'Employee' || role.name === 'Staff') && 'red.600') || 'blue.500'
            }
            color="white"
            position="relative"
            top="-2px"
        ...
        , here are some things you can access with your CodeDay account:
      </Text>
